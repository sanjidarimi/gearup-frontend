        ...
        <div className="relative z-10 mx-auto max-w-md my-auto space-y-6">
          <div className="rounded-2xl border border-border/80 bg-background/80 p-6 shadow-xl backdrop-blur-md">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-foreground">Verified Local Owners</h3>
                <p className="text-xs text-muted-foreground">Inspected and ready to use gear</p>
              </div>
            </div>
            <p className="text-xs text-muted-foreground leading-relaxed">
              Log in to manage active rentals, extend booking dates, or review incoming requests for gear you own.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-xl border border-border/60 bg-background/60 p-4 backdrop-blur-xs">
              ...
              <h5 className="text-xs font-bold text-foreground">Flexible Pickups</h5>
              <p className="text-[11px] text-muted-foreground mt-0.5">Contactless or in-person delivery.</p>
            </div>
            <div className="rounded-xl border border-border/60 bg-background/60 p-4 backdrop-blur-xs">
              <ShieldAlert className="h-5 w-5 text-primary mb-2" />
              <h5 className="text-xs font-bold text-foreground">Secure Payments</h5>
              <p className="text-[11px] text-muted-foreground mt-0.5">Powered by Stripe.</p>
            </div>
          </div>
        </div>
